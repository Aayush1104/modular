...
class NemotronTextModel(
    ...
    Dense decoder-only Transformer with LayerNorm1P normalization,
    squared ReLU activation, and partial rotary embeddings.
    """
    ...
    def __init__(self, config: NemotronConfig) -> None:
        ...
        # Partial RoPE: only apply to rotary_dim dimensions of each head.
